                ...
                <div className="p-[20px]">
                    ...
                    <div className="flex items-center justify-between mt-[50px]">
                        <Popover>
                            ...
                            <PopoverContent>
                                <p className="text-sm text-muted-foreground">This action cannot be undone. This will permanently delete your account
                                    and remove your data from our servers.
                                </p>
                                <Input className="m-[5px]" type='username' placeholder="Username" />
                                <Input className="m-[5px]" type='password' placeholder="Password" />
                                <Button className="mt-[5px] ml-[5px]" variant='destructive' onClick={deleteAccount}>Delete Account</Button>
                            </PopoverContent>
                        </Popover>
