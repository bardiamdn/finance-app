      ...
      <Card className="w-[380px] h-[165px] flex flex-col align-stretch justify-stretch">
        ...
        >
          <div className="flex flex-col justify-center items-center mr-10">
            <p style={{ color: "#25ff1dbd" }} className="mb-5">
              {balanceData.totalIncome.toLocaleString()}
            </p>
            <p style={{ color: "#ff1d1dbd" }}>
      ...
      <Card className="w-[641.3px] h-[340px]">
        ...
        >
          <div
            ...
            // className="flex flex-col items-start justify-start mb-[25px] bg-slate-500"
          >
            <ScrollArea
              width="100%"
              height="100%"
                  ...
                  <Dialog key={account._id}>
                    ...
                    >
                      <div className="flex flex-row">
                        ...
                        />
                        <p className="w-[150px] flex justify-start overflow-hidden whitespace-nowrap text-overflow-ellipsis">
